...
const instruments = List([PianoInstrument, PianoInstrument2, GuitarInstrument]);
const visualizers = List([WaveformVisualizer, AnthonyVisualizer, ColorSplashVisualizer]);
